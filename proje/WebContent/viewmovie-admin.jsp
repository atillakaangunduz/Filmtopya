...
<td><image src="<%=res.getString("filename")%>" width="150" height="200" /></td>
 <td>
<button class="btn btn-warning"><a href='edit-filmadmin.jsp?idmovie=<%=res.getString("idmovie")%>'>Düzenle </a></button>


<button class="btn btn-danger"><a href='delete.jsp?idmovie=<%=res.getString("idmovie")%>'>Sil </a></button>
...
document.getElementById("kayit").onclick = function(){
	location.href= 'add-filmadmin.jsp';
}
